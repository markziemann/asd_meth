...
## Gene ontology of top RUV DMPs

Gene Ontology analysis (gometh): top 1000 probes (RUV data).
...
res <- read.csv("ASD_blood_top_dmps_onADOS_withintw_Nov27_limma.csv", header = TRUE)
sigCpGs_1k = res$Name[1:1000]
