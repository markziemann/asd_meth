...
write.csv(output_ruv[order(output_ruv$F.p),],
  file="ASD_blood_topruv80pc_dmps_onADOS_withintw_Nov29.csv",
  row.names=FALSE)

write.csv(output_ruv_1000[order(output_ruv_1000$F.p),],
  file="ASD_blood_topruv80pc_1kdmps_onADOS_withintw_Nov29.csv",
  row.names=FALSE)
...
res <- read.csv("ASD_blood_topruv80pc_dmps_onADOS_withintw_Nov29.csv", header = TRUE)
