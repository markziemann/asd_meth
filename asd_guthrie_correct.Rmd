...
write.csv(gometh_kegg, file = "GOmeth_guthrie_kegg.csv", row.names = TRUE)

# GO terms
gometh_go <- gometh(sig.cpg = sigCpGs_1k, all.cpg = all, collection = "GO" , prior.prob=TRUE)
head( gometh_go[order(gometh_go$P.DE),] , 20)
write.csv(gometh_go, file = "GOmeth_guthrie_go.csv", row.names = TRUE)
...
plot(ilogit2(mDat[rownames(mDat) == "cg07926098",]), ADOS,
  main = "GRIK1: cg07926098", ylab = "ADOS z-score", xlab = "Beta Value")
regl5<-lm(ADOS ~ ilogit2(mDat[rownames(mDat) == "cg07926098",]))
abline(regl5)
cor.test(ADOS, ilogit2(mDat[rownames(mDat) == "cg07926098",]), method = "pearson")

plot(ilogit2(mDat[rownames(mDat) == "cg23088672",]), ADOS,
  main = "ULK1: cg23088672", ylab = "ADOS z-score", xlab = "Beta Value")
regl5<-lm(ADOS ~ ilogit2(mDat[rownames(mDat) == "cg23088672",]))
abline(regl5)
cor.test(ADOS, ilogit2(mDat[rownames(mDat) == "cg23088672",]), method = "pearson")

plot(ilogit2(mDat[rownames(mDat) == "cg10593232",]), ADOS, 
  main = "SPNS3: cg10593232", ylab = "ADOS z-score", xlab = "Beta Value")
regl5<-lm(ADOS ~ ilogit2(mDat[rownames(mDat) == "cg10593232",]))
abline(regl5)
cor.test(ADOS, ilogit2(mDat[rownames(mDat) == "cg10593232",]), method = "pearson")

plot(ilogit2(mDat[rownames(mDat) == "cg19893067",]), ADOS, 
  main = "TBCD: cg19893067", ylab = "ADOS z-score", xlab = "Beta Value")
regl5<-lm(ADOS ~ ilogit2(mDat[rownames(mDat) == "cg19893067",]))
abline(regl5)
cor.test(ADOS, ilogit2(mDat[rownames(mDat) == "cg19893067",]), method = "pearson")
...
#TLE4: cg21241156
plot(diff_effectsize_tot, diff_ADOS_score, main = "GRIK1: cg07926098",
