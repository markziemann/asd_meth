...
## BLOOD
bl_mres1 <- mitch_calc(bl_lim_m,go,priority="effect",cores=cores,minsetsize=5)
...
bl_mres2 <- mitch_calc(bl_lim_m,reactome,priority="effect",cores=cores,minsetsize=5)
...
## GUTHRIE
gu_mres1 <- mitch_calc(gu_lim_m,go,priority="effect",cores=cores,minsetsize=5)
...
# reactome
gu_mres2 <- mitch_calc(gu_lim_m,reactome,priority="effect",cores=cores,minsetsize=5)
